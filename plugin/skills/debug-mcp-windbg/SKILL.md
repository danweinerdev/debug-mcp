...
|---|---|---|
| Postmortem-analyze a dump file | `mcp__debug__open_crash_dump` | `dump_path` (required) |
| An automated crash report (`!analyze -v`) | `mcp__debug__analyze_crash` | — |
| Kernel-debug a machine over KDNET | `mcp__debug__attach_kernel` | `connection` (required) |
| List loaded modules/DLLs | `mcp__debug__get_modules` | — |
