...
|---|---|---|
| Stop at a file & line | `set_breakpoint` | `file` (required), `line` (required), `condition` |
| Stop when a function is entered | `set_function_breakpoint` | `name` (required), `condition` |
| See all breakpoints | `list_breakpoints` | — |
| Delete one | `remove_breakpoint` | `breakpoint_id` (required) |
